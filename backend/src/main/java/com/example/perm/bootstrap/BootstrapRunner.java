...
public class BootstrapRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        var mContractRoot = ensureModule(crmRoot, "合同管理", "contractMng", 2, 2006, "anticon-file-text", "营销", "crm/contract", null);
        var mContractBasic = ensureModule(mContractRoot, "合同基本信息管理", "contractBasic", 3, 2104, "anticon-profile", "营销", "crm/contract-basic", "/admin/contracts");
        var mContractExec = ensureModule(mContractRoot, "合同执行动态", "contractExec", 3, 2105, "anticon-linechart", "营销", "crm/contract-exec", "/admin/contract-executions");
        ...
        var allModules = List.of(mUser, mRole, mOpt, mMod, mPerm, crmRoot, mCustomer, mArea, mStaff, mProduct, mDevice, mSpare, mPackage, mPrice, mContractRoot, mContractBasic, mContractExec);
